...
class Scroller:
    ...
    def __init__(self, driver,output_file_name) -> None:
        self.driver = driver
    ...
    def start_parsing(self):
        ...
        self.parser.main(self.__allResultsLinks,self.output_file_name)
    ...
    def scroll(self):
        ...
        if scrollAbleElement is None:
            ...
            print("We are sorry but, No results found for your search query on googel maps....")
